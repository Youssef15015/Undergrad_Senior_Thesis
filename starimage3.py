...
ax1.hist(h1.s[gas_mask]['r'],bins=nbins,histtype='step',color='r',label='Simulated Star Particles('+count+')')
...
ax2=ax1.twinx()
ax2.hist(Y,bins=nbins,histtype='step',color='b',label='Galactic Globular Clusters(157)')
