...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  sixth[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  seventh[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  eigth[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  ninth[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  tenth[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  eleven[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twelve[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  fourteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  fifteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  sixteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  seventeen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  eighteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  ninteen[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twenty[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentyone[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentytwo[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentythree[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentyfour[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentyfive[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentysix[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentyseven[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentyeight[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  twentynine[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirty[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtyone[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtytwo[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtythree[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtyfour[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtyfive[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtysix[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtyseven[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtyeight[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  thirtynine[i] and Pressure[i] >=10**5  ]
...
ids_gas = [Ids_gas[i] for i in range(len(Ids_gas)) if  fourty[i] and Pressure[i] >=10**5  ]
